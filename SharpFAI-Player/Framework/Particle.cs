...
/// <summary>
/// Particle class - 粒子类 (优化后版本)
/// 优化特性：
/// - 使用 Vector4 打包颜色，减少内存占用和访问开销
/// - 使用属性而非字段，提供统一的访问接口
/// - 移除不必要的数学运算（sqrt），使用线性衰减
/// - IsAlive 改为属性，统一访问方式
/// </summary>
public class Particle
{
    ...
    /// <summary>
    /// 粒子颜色 (RGBA)
    /// 优化：相比 4 个 float (R/G/B/A)，Vector4 是单个 struct，访问更高效
    /// </summary>
    ...
    /// 更新粒子状态
    /// 优化：
    /// - 移除 Sqrt 运算（高开销），改为线性衰减
    /// - 直接更新 Color 的 Alpha 分量，避免重复构造 Vector4
    /// </summary>
