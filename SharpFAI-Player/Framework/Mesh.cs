...
public class Mesh : IMesh
{
    ...
    /// <summary>
    /// Vertex colors as Vector4 (RGBA in [0,1]) / 顶点颜色（Vector4 RGBA）
    /// 优化：相比 Color[]，Vector4[] 避免在 GPU 上传时的转换开销
    /// </summary>
    public Vector4[] Colors { get; set; }

    /// <summary>
    /// 接口实现: 为了支持优化的 Vector4 颜色存储，同时保持 IMesh 兼容性
    /// 该属性提供 Color[] 视图用于接口实现
    /// </summary>
    Color[] IMesh.Colors
    {
    ...
    /// <summary>
    /// Transform all vertices by a matrix / 通过矩阵变换所有顶点
    /// </summary>
    ...
    /// <summary>
    /// 转换 Vector4 颜色数组为 Color 数组（用于接口兼容性）
    /// </summary>
    ...
    /// <summary>
    /// 转换 Color 数组为 Vector4 颜色数组（用于接口兼容性）
    /// </summary>
