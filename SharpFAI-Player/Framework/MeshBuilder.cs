...
public class MeshBuilder
{
    ...
    /// <summary>
    /// Add a vertex to the mesh / 向网格添加顶点
    /// </summary>
    ...
    /// <summary>
    /// Add a triangle by vertex indices / 通过顶点索引添加三角形
    /// </summary>
    ...
    /// <summary>
    /// Add a quad by vertex indices / 通过顶点索引添加四边形
    /// </summary>
    ...
    /// <summary>
    /// Build and return the mesh / 构建并返回网格
    /// </summary>
    public Mesh Build()
    {
        // 转换 Color[] 为 Vector4[]
